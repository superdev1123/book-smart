...
import { addTitle, addLocationItem, getTitleList, getLocationList, PostJob, getAllRestaurants } from '../../../utils/useApi';
import Loader from '../../Loader';
import { RFValue } from 'react-native-responsive-fontsize';

const { width, height } = Dimensions.get('window');

export default function HospitalityAddRestaurantJob({ navigation }) {
