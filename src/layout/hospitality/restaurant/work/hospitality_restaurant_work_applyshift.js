...
import { View, StyleSheet, ScrollView, StatusBar, Alert, TouchableOpacity, TextInput, KeyboardAvoidingView, Platform, TouchableWithoutFeedback, Keyboard } from 'react-native';
...
export default function HospitalityRestaurantWorkApplyShift ({ navigation, route }) {
