...
export default function HospitalityRestaurantWorkBookShift ({ navigation }) {
  ...
  const handleEdit = (id) => {
    ...
    navigation.navigate("HospitalityRestaurantWorkApplyShift", { modalData: filteredDetailData[id], firstName: firstName, lastName: lastName, aic: aic }); 
  };
      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.topView}>
            <AnimatedHeader title="RESTAURANT JOB / SHIFT LISTINGS" />
