...
export default function HospitalityRestaurantWorkMyShift ({ navigation }) {
  ...
  const handleUploadEdit = (id) => {
    ...
    // toggleUploadModal();
    navigation.navigate('HospitalityRestaurantWorkUploadTimesheet', { detailInfo: detailInfo, fileData: infoData });
  };
