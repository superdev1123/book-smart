...
import { Modal, TextInput, View, Image, Platform, Alert, StyleSheet, 
...
export default function HospitalityHotelWorkMyShift ({ navigation }) {
  ...
  const handleUploadEdit = (id) => {
    ...
    // toggleUploadModal();
    navigation.navigate('HospitalityHotelWorkUploadTimesheet', { detailInfo: detailInfo, fileData: infoData });
  };
